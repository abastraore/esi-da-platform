    ...
    <tr>
      ...
      <td>
        <div style="display:flex;gap:4px">
          <button class="btn-icon" title="Modifier" onclick="editCours(${c.cours_id})">✏️</button>
          <button class="btn-icon" title="Supprimer" onclick="deleteCours(${c.cours_id})">🗑️</button>
        </div>
      </td>
    </tr>`).join('');
}
